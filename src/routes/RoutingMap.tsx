...
const Plan: LazyExoticComponent<ComponentType> = lazy(() => import('../pages/plan/Plan'));
const RootLayout: LazyExoticComponent<ComponentType> = lazy(() => import('../layouts/RootLayout'));
const ErrorPage: LazyExoticComponent<ComponentType> = lazy(() => import('../pages/erroPage/ErrorPage'));
...
const RoutingMap = (): RouteObject[] => {
    ...
    return [
        createRoute('/', <RootLayout />, [home, about, user], <ErrorPage />)
    ];
};
